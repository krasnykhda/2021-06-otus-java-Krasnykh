...
public class UsersWebServerSimple implements UsersWebServer {
    ...
    private ServletContextHandler createServletContextHandler() {
        ...
        servletContextHandler.addServlet(new ServletHolder(new UsersServlet(templateProcessor,dbServiceClient)), "/clients");
        servletContextHandler.addServlet(new ServletHolder(new UsersApiServlet(gson,dbServiceClient)), "/api/user/*");
        return servletContextHandler;
    }
}
